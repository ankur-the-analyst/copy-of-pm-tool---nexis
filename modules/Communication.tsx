         ...
         <div className={`flex-1 flex overflow-hidden ${viewMode === 'pip' ? 'block' : 'flex-col md:flex-row'}`}>
             ...
             {viewMode === 'pip' ? (
               ...
               <>
                 ...
                 <div className="w-full md:w-64 bg-slate-900 border-l border-slate-800 flex flex-row md:flex-col p-3 space-x-3 md:space-x-0 md:space-y-3 overflow-x-auto md:overflow-y-auto shrink-0 z-60 pointer-events-auto">
